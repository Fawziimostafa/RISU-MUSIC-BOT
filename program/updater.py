...
async def update_bot(_, message: Message):
    ...
    if update_avail:
        await msg.edit("✅ ᴜᴘᴅᴀᴛᴇ ғɪɴɪsʜᴇᴅ !\n\n• ʙᴏᴛ ʀᴇsᴛᴀʀᴛɪɴɢ, ʙᴀᴄᴋ active ᴀɢᴀɪɴ ɪɴ 1 ᴍɪɴᴜᴛᴇs.")
        system("git pull -f && pip3 install --no-cache-dir -r requirements.txt")
        execle(sys.executable, sys.executable, "main.py", environ)
        return
    await msg.edit(f"❖ ʙᴏᴛ ɪs **ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ** ᴡɪᴛʜ [sᴜᴍɪᴛ ʏᴀᴅᴀᴠ]({UPSTREAM_REPO}/tree/main) ❖", disable_web_page_preview=True)
...
async def restart_bot(_, message: Message):
    ...
    await msg.edit("✅ ʙᴏᴛ ʀᴇsᴛᴀʀᴛᴇᴅ !\n\n• ᴡᴀɪᴛ ᴜɴᴛɪʟ 1 ᴍɪɴᴜᴛᴇs ᴀғᴛᴇʀ ʙᴏᴛ ʀᴇʙᴏᴏᴛᴇᴅ.")
